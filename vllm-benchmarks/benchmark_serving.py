...
async def get_request(
    ...
    Args:
        ...
        rpm (optional):
            Requests per minute. If provided, this value will override request_rate.
    """
    input_requests = iter(input_requests)

    # Convert RPM to requests per second if RPM is provided
    if rpm is not None:
        request_rate = rpm / 60.0
    ...
    for request in input_requests:
        ...
        if rpm is not None:
            # If RPM is provided, interval should be a fixed value.
            interval = 1.0
